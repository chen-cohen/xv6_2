...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ed:	0f b6 80 78 0a 00 00 	movzbl 0xa78(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 54a:	75 09                	jne    555 <printf+0x101>
          s = "(null)";
 54c:	c7 45 f4 2a 08 00 00 	movl   $0x82a,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 617:	a1 94 0a 00 00       	mov    0xa94,%eax
...
free(void *ap)
{
 ...
 6e2:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 6e7:	c9                   	leave  
 6e8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 753:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 756:	a1 94 0a 00 00       	mov    0xa94,%eax
 75b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 75e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 762:	75 23                	jne    787 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 764:	c7 45 f0 8c 0a 00 00 	movl   $0xa8c,-0x10(%ebp)
 76b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 76e:	a3 94 0a 00 00       	mov    %eax,0xa94
 773:	a1 94 0a 00 00       	mov    0xa94,%eax
 778:	a3 8c 0a 00 00       	mov    %eax,0xa8c
    base.s.size = 0;
 77d:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 784:	00 00 00 
  }
 ...
 7da:	a3 94 0a 00 00       	mov    %eax,0xa94
      return (void*)(p + 1);
 ...
 7e5:	eb 38                	jmp    81f <malloc+0xde>
    ...
    if(p == freep)
 7e7:	a1 94 0a 00 00       	mov    0xa94,%eax
