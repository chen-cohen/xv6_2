...
printint(int fd, int xx, int base, int sgn)
{
 ...
 411:	0f b6 80 c0 0a 00 00 	movzbl 0xac0(%eax),%eax
...
free(void *ap)
{
 ...
 63b:	a1 dc 0a 00 00       	mov    0xadc,%eax
...
free(void *ap)
{
 ...
 706:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 70b:	c9                   	leave  
 70c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 759:	e8 ce fe ff ff       	call   62c <free>
  return freep;
 75e:	a1 dc 0a 00 00       	mov    0xadc,%eax
}
 763:	c9                   	leave  
 764:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 788:	c7 45 f0 d4 0a 00 00 	movl   $0xad4,-0x10(%ebp)
 78f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 792:	a3 dc 0a 00 00       	mov    %eax,0xadc
 797:	a1 dc 0a 00 00       	mov    0xadc,%eax
 79c:	a3 d4 0a 00 00       	mov    %eax,0xad4
    base.s.size = 0;
 7a1:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7a8:	00 00 00 
  }
 ...
 7fe:	a3 dc 0a 00 00       	mov    %eax,0xadc
      return (void*)(p + 1);
 ...
 809:	eb 38                	jmp    843 <malloc+0xde>
    ...
    if(p == freep)
 80b:	a1 dc 0a 00 00       	mov    0xadc,%eax
